...
def get_argparser():
    ...
    #Dataset options
    parser.add_argument('--dataset', type=str, default='GD',
    ...
    parser.add_argument('--save_picture_path',default='/home/yzr/msdis/mycode/pictures',type=str, help='保存图片路径')
    return parser
...
def get_dataset(opts):
    if opts.dataset == 'SD':
        ...
        origin_data_dict['SD'] = all_matrix
...
def main():
    ...
    predict_data_draw(origin_data,pred_result_value,save_picture_path,opts.dataset)
